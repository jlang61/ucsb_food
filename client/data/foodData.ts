...
"name": "De La Guerra",
"meals": {
"Brunch": ["Dilled Vegetable Barley Soup", "Buffalo Chicken Drumstick", "Sauteed Swiss Chard with Garlic", "Baked Potato", "Vegetable & Jalapeno Pizza", "Mushroom & Rstd Onion Pizza on Wheat", "Herb Breadsticks", "Oatmeal", "Cage Free Scrambled Eggs", "Cage Free Scrambled Egg Whites", "Pancakes", "Diced Potatoes with Onions", "Grilled Ham", "Waffle", "Multi-Grain Waffle", "Chicken & Sundried Tomato Pasta Salad", "Sliced Cantalope", "Sliced Honeydew", "Grapefruit Halves", "Sliced Pineapple", "Bagels-Breads & Cereals- See for Choices", "Strawberry Muffin"],
...
"Dinner": ["Argentina Locro Stew", "Lomo Saltado with Green Aji Sauce", "Papa a la Huancaina", "Haricot Vert Green Bean (Frozen)", "Baked Potato", "Colombian Arroz con Pollo", "Ceviche con Cancha (gf)", "White Spanish Rice", "Navy White Beans", "Flour Tortilla", "Corn Tortilla", "Wheat Tortilla", "Ranchero Salsa", "Beef Empanada", "Cheese Pizza", "Herb Breadsticks", "Peruvian Arroz Chaufa", "Brazilian Tofu Moqueca", "Long Grain Rice", "Brown Rice", "Solterito Peruvian Quinoa Salad", "Cheese Roll", "Chocotorta"],
}
},
{
"name": "Ortega",
