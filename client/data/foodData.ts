...
"Lunch": ["Sliced Ham", "Ensalada de Nopales", "Sliced Provolone Cheese", "Sliced Pepper Jack Cheese", "Pollo Asado", "Carnitas Taco", "Chicken Mole (w/nuts)", "Arroz Blanco", "Calabacitas", "Tamales de Puerco", "Green Chili & Cheese Tamales", "Tamales de Rajas", "Ensalada de Chivo (Salpicon Style Goat)", "Esquites", "Chorizo Pizza", "Molletes", "Traditional Cheese Pizza on Wheat", "Sopa de Lima", "Steak Ranchero", "Mexican Rice", "Gardenburger", "Pinto Beans", "Shrimp Sope w/Roasted Poblano Crema", "Chicharron en Salsa Verde", "Mexican Crispy Roasted Potatoes", "Baked Potato", "Baked Sweet Potato", "Long Grain Rice", "Fresas con Crema", "Chocoflan", "Churro", "Pan con Queso y Jalapeno"],
"Dinner": ["Couscous Salad with Tomato & Herb", "Greek Salad", "Sticky Rice", "Pork & Veggie Stir Fry", "Stir Fry Noodles with Vegetables", "Tortilla Chicken Soup", "Rotisserie Chicken", "Fresh Green Beans", "Fresh Broccoli Spears", "Roasted Potato Wedges", "Roasted  Red Potato Wedges", "Risotto with Fresh Vegetables", "Caesar Salad", "Penne Pasta", "Chicken Marinara Sauce", "Linguini Pasta", "Fresh Basil Sauce", "Black Beans", "Baked Potato", "Baked Sweet Potato", "Jasmine Rice", "Sausage Olive Pizza", "Vegetable Pizza on Wheat", "Cheese Pizza on White", "Bread Olive", "Yellow Cake with Chocolate Icing"],
}
},
{
"name": "De La Guerra",
...
"name": "Portola",
"meals": {
"Brunch": ["Pineapple", "Fresh Strawberry", "Cantaloupe", "Cinnamon Maple Granola", "Quinoa Breakfast Bowl (w/nuts)", "8 Grain Hot Cereal", "Steamed White Rice", "Make Your Own Waffle", "Sugar Snap Peas", "Ginger Sesame Tofu", "Couscous", "Salami Pizza", "Chicken Chilaquiles", "Mushroom Cream Sauce", "Chickpea Pasta", "Orange Scone", "Flour Tortilla", "Hot Turkey Sandwich", "Grilled Cheese on Sourdough", "White Beans", "Mixed Greens Side Salad", "Spicy Navy Bean Soup", "Fresh Cage Free Scrambled Eggs", "Cage Free Scrambled Egg Whites", "Scrambled Eggs with Ham & Cheese", "Buttermilk Pancakes", "Cauliflower w/Sugar Snap Peas", "Roasted Breakfast Potato"],
...
"Lunch": ["Hearty Vegetable Soup", "Italian Chopped Sandwich", "Fresh Steamed Carrots", "Baked Potato", "Baked Sweet Potato", "Chicken Chile Verde Burrito", "Potato Taco", "Mexican Rice", "Pinto Beans", "Flour Tortilla", "Corn Tortilla", "Wheat Tortilla", "Roasted Tomato and Chile Salsa", "Chicken Garlic Pesto Pizza", "Tomato Basil Pizza", "Herb Breadsticks", "Sesame Chicken Stir Fry w/Brown Rice", "Vegetable Chop Suey", "Long Grain Rice", "Brown Rice", "Grilled Chicken Breast Sandwich", "Malibu Burger", "Grilled Cheese on Sourdough", "Shoestring French Fries", "Egg Salad", "Three Grain Roll", "Killer Brownie"],
